...
const Miamour = () => {
  ...
  return (
    ...
    >
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 py-24 sm:px-6 lg:px-8">
          ...
          >
            <motion.div 
              ...
              className="mx-auto w-24 h-24 bg-gradient-to-br from-pink-600 to-purple-600 rounded-2xl flex items-center justify-center mb-6"
            >
            ...
            <div className="mt-10 flex justify-center gap-4">
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                href="#"
                className="px-8 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-medium rounded-lg shadow-lg hover:shadow-purple-500/30 transition-all"
              >
                Join Now
              </motion.a>
              <motion.a
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className="w-14 h-14 bg-gray-800 rounded-lg flex items-center justify-center mb-4">
                {feature.icon}
              </div>
      ...
      <div className="relative bg-gray-800/30 py-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <motion.div
                ...
                className="bg-gray-800/50 p-6 rounded-xl border border-gray-700 hover:border-pink-500 transition-all"
              >
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-24 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-r from-purple-900/40 to-pink-900/40 rounded-2xl p-8 md:p-12 border border-purple-500/20">
          <div className="text-center">
            ...
            >
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                href="#"
                className="px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-medium rounded-lg shadow-lg hover:shadow-purple-500/30 transition-all"
              >
                Sign Up Free
              </motion.a>
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                href="#"
                className="px-8 py-4 bg-gray-800 text-white font-medium rounded-lg border border-gray-700 hover:bg-gray-700 transition-all"
              >
                Take a Tour
              </motion.a>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center mb-4 md:mb-0">
              <div className="w-10 h-10 bg-gradient-to-br from-pink-600 to-purple-600 rounded-lg flex items-center justify-center mr-3">
            ...
            <div className="flex space-x-6">
              ...
              <a href="#" className="text-gray-400 hover:text-purple-400 transition-colors">Features</a>
