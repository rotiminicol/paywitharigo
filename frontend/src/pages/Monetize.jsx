...
const Monetize = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      ...
      <div className="bg-gradient-to-r from-purple-900 to-black text-white">
        <div className="container mx-auto px-4 py-8 md:py-12">
          <div className="animate-fade-in-down">
            <h1 className="text-2xl md:text-3xl font-bold mb-2">Monetize Your Content</h1>
            <p className="text-purple-300 mb-6 md:mb-8">Turn your passion into income with Ijeuwas monetization tools</p>
            
            {/* Tabs - Improved for mobile */}
            <div className="flex overflow-x-auto hide-scrollbar space-x-1 bg-gray-800 rounded-lg p-1">
              {tabs.map(tab => (
                <button
                  key={tab.id}
                  onClick={() => setActiveTab(tab.id)}
                  className={`px-3 py-2 md:px-4 rounded-md text-xs md:text-sm font-medium transition-all duration-300 whitespace-nowrap flex-shrink-0 ${
                    activeTab === tab.id 
        ...
        {loading ? (
          <div className="animate-pulse space-y-6 md:space-y-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              {[1, 2, 3, 4].map(i => (
                <div key={i} className="bg-gray-800 rounded-lg shadow-md p-4 md:p-6 h-28 md:h-32 border border-gray-700">
                  <div className="h-4 md:h-5 bg-gray-700 rounded w-1/2 mb-3 md:mb-4"></div>
                  <div className="h-6 md:h-8 bg-gray-700 rounded w-3/4 mb-2"></div>
            ...
            <div className="bg-gray-800 rounded-lg shadow-md p-4 md:p-6 border border-gray-700">
              <div className="h-5 md:h-6 bg-gray-700 rounded w-1/3 mb-4 md:mb-6"></div>
              <div className="h-32 md:h-40 bg-gray-700 rounded w-full"></div>
            </div>
          </div>
        ) : isEligible ? (
          <>
            {/* Stats Cards - Improved grid for mobile */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 mb-6 md:mb-8 animate-fade-in">
              {stats.map((stat, index) => (
                <div 
                  key={index} 
                  className="bg-gray-800 rounded-lg shadow-md p-4 md:p-6 hover:shadow-lg transition-shadow duration-300 border border-gray-700"
                  style={{ animationDelay: `${index * 100}ms` }}
                >
                  <div className="flex justify-between items-start mb-3 md:mb-4">
                    <div className="font-medium text-sm md:text-base text-gray-400">{stat.title}</div>
                    <div className="p-1 md:p-2 bg-gray-700 rounded-lg">
            ...
            {/* Revenue Chart - Improved for mobile */}
            <div className="bg-gray-800 rounded-lg shadow-md p-4 md:p-6 mb-6 md:mb-8 animate-fade-in border border-gray-700" style={{ animationDelay: '200ms' }}>
                  ...
                  {chartData.map((item, index) => {
                    ...
                    return (
                      <div key={index} className="flex flex-col items-center justify-end" style={{ height: '100%', width: `${100 / chartData.length}%` }}>
                        <div 
                          className="w-3/5 sm:w-4/5 bg-gradient-to-t from-purple-600 to-purple-900 rounded-t-lg relative group transition-all duration-500"
                          style={{ height: `${heightPercentage}%` }}
                        >
                          <div className="absolute -top-8 md:-top-10 left-1/2 transform -translate-x-1/2 bg-gray-900 text-white px-2 py-1 rounded text-xs opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap border border-gray-700">
                            ${item.amount}
                          </div>
                        </div>
            ...
            {/* Monetization Options - Improved for mobile */}
            <h2 className="text-lg md:text-xl font-bold text-white mb-3 md:mb-4 animate-fade-in" style={{ animationDelay: '300ms' }}>Monetization Options</h2>
                ...
                >
                  ...
                  <div className="p-4 md:p-6">
                    <div className="flex flex-col sm:flex-row sm:items-start mb-4 sm:mb-0">
                      <div className="flex-shrink-0 p-2 md:p-3 bg-gray-700 rounded-lg mb-3 sm:mb-0 sm:mr-4">
                    ...
                    <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <h4 className="text-sm font-medium text-gray-300 mb-2 flex items-center">
                          <Lightbulb size={14} className="mr-2 text-purple-400" />
                          Requirements
                        </h4>
                        <ul className="text-xs md:text-sm text-gray-400 space-y-1">
                          {option.requirements.map((req, i) => (
                            <li key={i} className="flex items-start">
                              <Check size={14} className="mr-2 text-purple-400 flex-shrink-0 mt-0.5" />
                              <span>{req}</span>
                            </li>
                          ))}
                        </ul>
            ...
            {/* Get Started Section - Improved for mobile */}
            <div className="bg-gray-800 rounded-lg shadow-md p-4 md:p-8 mb-6 md:mb-8 animate-fade-in border border-gray-700" style={{ animationDelay: '600ms' }}>
              <div className="flex flex-col md:flex-row items-center justify-between">
                <div className="mb-6 md:mb-0 md:mr-6 text-center md:text-left">
                  ...
                  <button className="py-2 md:py-3 px-4 md:px-6 bg-purple-600 hover:bg-purple-700 text-white rounded-md font-medium flex items-center justify-center transition-colors duration-300 mx-auto md:mx-0">
                    <CreditCard size={16} className="mr-2" />
                    Set Up Payment Methods
                  </button>
                </div>
                <div className="flex-shrink-0 bg-purple-900/30 rounded-lg p-4 md:p-6 border border-purple-500/30 w-full md:w-auto">
                  <div className="flex flex-col space-y-3 md:space-y-4">
                    <div className="flex items-center text-gray-300 text-sm md:text-base">
                      <div className="flex-shrink-0 w-6 h-6 md:w-8 md:h-8 bg-purple-800 rounded-full flex items-center justify-center mr-2 md:mr-3">
            ...
            {/* Creator Tips - Improved for mobile */}
            <div className="bg-gradient-to-r from-purple-900 to-black rounded-lg shadow-md p-4 md:p-8 text-white animate-fade-in border border-purple-500/30" style={{ animationDelay: '700ms' }}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
                ...
                <div className="bg-purple-900/30 p-3 md:p-4 rounded-lg border border-purple-500/30 sm:col-span-2 md:col-span-1">
                  <h3 className="font-medium mb-2 flex items-center text-sm md:text-base">
              ...
              <div className="mt-4 md:mt-6 text-center">
                <a href="#" className="inline-flex items-center text-purple-300 text-sm underline hover:text-purple-200 transition-colors">
          ...
          // Not eligible content - Improved for mobile
          <div className="bg-gray-800 rounded-lg shadow-md p-4 md:p-8 text-center max-w-2xl mx-auto animate-fade-in border border-gray-700">
            <div className="w-16 h-16 md:w-20 md:h-20 bg-red-900/30 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6 border border-red-500/30">
            ...
            <div className="bg-gray-700 rounded-lg p-4 md:p-6 mb-4 md:mb-6 border border-gray-600">
              ...
              <ul className="text-left space-y-3">
                ...
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-5 h-5 md:w-6 md:h-6 bg-purple-900/30 rounded-full flex items-center justify-center mt-0.5 mr-2 md:mr-3 border border-purple-500/30">
            ...
            <button className="py-2 md:py-3 px-4 md:px-6 bg-purple-600 hover:bg-purple-700 text-white rounded-md font-medium transition-colors duration-300 text-sm md:text-base">
      ...
      <div className="bg-gray-800 mt-8 md:mt-12 py-4 md:py-6 border-t border-gray-700">
